...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getProtocolAccess().getBeginAlternatives_1_0(), "rule__Protocol__BeginAlternatives_1_0");
			builder.put(grammarAccess.getMessageAccess().getAlternatives(), "rule__Message__Alternatives");
			builder.put(grammarAccess.getMessageBaseAccess().getAlternatives_1(), "rule__MessageBase__Alternatives_1");
			...
			builder.put(grammarAccess.getChoiceBranchLAccess().getAlternatives(), "rule__ChoiceBranchL__Alternatives");
			...
			builder.put(grammarAccess.getMessageBaseAccess().getGroup(), "rule__MessageBase__Group__0");
			builder.put(grammarAccess.getMessageBaseAccess().getGroup_1_0(), "rule__MessageBase__Group_1_0__0");
			...
			builder.put(grammarAccess.getChoiceBranchLAccess().getGroup_0(), "rule__ChoiceBranchL__Group_0__0");
			builder.put(grammarAccess.getChoiceBranchLAccess().getGroup_1(), "rule__ChoiceBranchL__Group_1__0");
			...
			builder.put(grammarAccess.getProtocolAccess().getBeginAssignment_1(), "rule__Protocol__BeginAssignment_1");
			...
			builder.put(grammarAccess.getMessageBaseAccess().getMessageTypeAssignment_0(), "rule__MessageBase__MessageTypeAssignment_0");
			builder.put(grammarAccess.getMessageBaseAccess().getPayloadAssignment_1_0_1(), "rule__MessageBase__PayloadAssignment_1_0_1");
			builder.put(grammarAccess.getMessageBaseAccess().getSenderAssignment_3(), "rule__MessageBase__SenderAssignment_3");
			builder.put(grammarAccess.getMessageBaseAccess().getReceiverAssignment_5(), "rule__MessageBase__ReceiverAssignment_5");
			builder.put(grammarAccess.getMessageBaseAccess().getProtocolAssignment_7(), "rule__MessageBase__ProtocolAssignment_7");
			...
			builder.put(grammarAccess.getMessageLAccess().getSendReceiveAssignment_4(), "rule__MessageL__SendReceiveAssignment_4");
			...
			builder.put(grammarAccess.getChoiceBranchLAccess().getMessageAssignment_1_0(), "rule__ChoiceBranchL__MessageAssignment_1_0");
			builder.put(grammarAccess.getChoiceBranchLAccess().getProtocolAssignment_1_1(), "rule__ChoiceBranchL__ProtocolAssignment_1_1");
